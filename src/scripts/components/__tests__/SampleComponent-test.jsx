...
describe('SampleComponent tests', () => {
    it('should be rendered correctly with empty data)', () => {
        const store = mockStore({ sample: new SampleInitialState() });
        const tree = renderer
            .create(
    ...
    it('should be rendered correctly while fetching', () => {
        const store = mockStore({ sample: new SampleInitialState(fetchingState) });
        const tree = renderer
            .create(
                <Provider store={store}>
                    <SampleComponent />
    ...
    it('should be rendered correctly with if error occurs', () => {
        ...
        const store = mockStore({ sample: new SampleInitialState(errorState) });
        const tree = renderer
            .create(
                <Provider store={store}>
                    <SampleComponent />
