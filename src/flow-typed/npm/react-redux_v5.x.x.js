...
declare module 'react-redux' {
    ...
    */
    ...
    declare export type Connector<OP, P> = (<DP: {}, CP: {}>(
    ...
    declare export function connect<A, OP>(
    ...
    declare export function connect<S, A, OP, SP>(
    ...
    declare export function connect<A, OP, DP>(
        mapStateToProps: Null,
    ...
    declare export function connect<S, A, OP, SP, DP>(
        mapStateToProps: MapStateToProps<S, OP, SP>,
        mapDispatchToProps: MapDispatchToProps<A, OP, DP>,
        mergeProps: Null,
        options?: ConnectOptions
    ...
    declare export function connect<S, A, OP, SP, DP, P>(
        mapStateToProps: MapStateToProps<S, OP, SP>,
        mapDispatchToProps: Null,
